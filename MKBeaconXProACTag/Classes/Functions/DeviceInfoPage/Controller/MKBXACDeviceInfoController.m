...
@interface MKBXACDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXACDeviceInfoModel *dataModel;

@end

@implementation MKBXACDeviceInfoController
...
- (MKBXACDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBXACDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
