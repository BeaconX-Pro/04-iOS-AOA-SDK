...
@interface MKBXACPowerConfigController ()<UITableViewDelegate,
UITableViewDataSource,
MKBXACStaticTriggerTimeCellDelegate,
...
@property (nonatomic, strong)MKBXACPowerConfigModel *dataModel;

@end

@implementation MKBXACPowerConfigController

- (void)dealloc {
    NSLog(@"MKBXACPowerConfigController销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MKBXACStaticTriggerTimeCell *cell = [MKBXACStaticTriggerTimeCell initCellWithTableView:tableView];
...
- (void)loadSection1Datas {
    MKBXACStaticTriggerTimeCellModel *cellModel = [[MKBXACStaticTriggerTimeCellModel alloc] init];
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKBeaconXProACTag", @"MKBXACPowerConfigController", @"bxa_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKBXACPowerConfigModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKBXACPowerConfigModel alloc] init];
    }
    return _dataModel;
}
