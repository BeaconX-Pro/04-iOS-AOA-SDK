...
@interface MKBXACDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBXACDFUModule

- (void)dealloc{
    NSLog(@"MKBXACDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBXACCentralManager shared].peripheral];
}
