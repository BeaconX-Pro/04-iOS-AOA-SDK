...
@interface MKBXACUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKBXACDFUModule *dfuModule;
...
@implementation MKBXACUpdateController

- (void)dealloc {
    NSLog(@"MKBXACUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxa_startDfuProcessNotification" object:nil];
    ...
    @weakify(self);
    [self.dfuModule updateWithFileUrl:filePath progressBlock:nil sucBlock:^{
        @strongify(self);
...
- (void)updateComplete {
    ...
    [MKBXACCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_bxa_centralDeallocNotification" object:nil];
...
- (MKBXACDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKBXACDFUModule alloc] init];
    }
    return _dfuModule;
}
