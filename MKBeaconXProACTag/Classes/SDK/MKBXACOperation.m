...
/**
 线程ID
 */
@property (nonatomic, assign)mk_bxa_taskOperationID operationID;
...
@implementation MKBXACOperation
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKBXACTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKBXACTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_bxa_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_bxa_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
