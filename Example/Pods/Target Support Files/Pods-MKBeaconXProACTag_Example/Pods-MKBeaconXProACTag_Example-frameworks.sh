...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MKBeaconXCustomUI/MKBeaconXCustomUI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MKBeaconXProACTag/MKBeaconXProACTag.framework"
